...
function useMouseDownHandlers(ContainerRef, mouseEventSource) {
  ...
  var onClick = (0, import_react.useCallback)(function onClick2(event) {
    ...
    closeAllOpenToggles();
    var _emojiFromEvent = emojiFromEvent(event, emojiByUnified3), emoji = _emojiFromEvent[0], unified = _emojiFromEvent[1];
    if (!emoji || !unified) {
      return;
    }
  ...
  }, [activeSkinTone, closeAllOpenToggles, disallowClickRef, emojiByUnified3, onEmojiClick, updateSuggested, getEmojiUrl, activeEmojiStyle]);
  var onMouseDown = (0, import_react.useCallback)(function onMouseDown2(event) {
    var _window;
    if (mouseDownTimerRef.current) {
      clearTimeout(mouseDownTimerRef.current);
    }
    var _emojiFromEvent2 = emojiFromEvent(event, emojiByUnified3), emoji = _emojiFromEvent2[0];
  ...
  }, [disallowClickRef, emojiByUnified3, closeAllOpenToggles, setVariationPicker, setEmojiVariationPicker]);
